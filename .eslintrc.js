module.exports = {
  ...
  "rules": {
    ...
    "valid-jsdoc": [2, {"requireReturn": false, "matchDescription": "^[A-Z][A-Za-z0-9\\s]*[.]$"}], // Ensure JSDoc comments are valid (off by default)
    ...
    "id-length": [2, {"min": 3}], //this option enforces minimum and maximum identifier lengths (variable names, property names etc.)
    ...
    "max-len": [2, 120, 2], // specify the maximum length of a line in your program
    ...
    "one-var": [2, {"var": "always", "let": "always","const": "never"}], // allow just one var statement per function (off by default)
    ...
    "require-jsdoc": [2, {"require": {"FunctionDeclaration": true, "MethodDefinition": true, "ClassDeclaration": true}}], // Require JSDoc comment
    ...
    // TODO remove after extending from custom eslint config package
    "no-extra-parens": 0 // overwrite the rule so that react can be used normally
  }
};
